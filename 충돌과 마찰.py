...
#Creating Objects
ball1 = sphere(radius=2*65.5e-3, make_trail = True, retain = 100)
ball2 = sphere(radius=2*65.5e-3, make_trail = True, pos=vec(0.5,-0.5*65.5e-3,0), color=color.red, retain = 100)
...
def collision(b1, b2, e): 
    ...
    v_relm = dot(b1.v - b2.v, n_hat) # 멀어지는 상황
    if v_relm > 0:
        return False
